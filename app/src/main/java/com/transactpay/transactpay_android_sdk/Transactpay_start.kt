...
class Transactpay_start : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cardLayout?.setOnClickListener {
            paymentOption = "Card"
            val url = "https://payment-api-service.transactpay.ai/payment/order/fee"
            try {
                CoroutineScope(Dispatchers.IO).launch {
                    ...
                    withContext(Dispatchers.Main) {
                        if (status == "success") {
                            ...
                            val intent = Intent(this@Transactpay_start, Failed::class.java).apply {
        ...
        findViewById<Button>(R.id.makePayment).setOnClickListener{
            ...
            val intent = when(paymentOption) {
                ...
                "Bank-transfer" -> Intent(this@Transactpay_start, BankTransfer::class.java) // Replace with your actual Bank Transfer Activity
                else -> null
            }
